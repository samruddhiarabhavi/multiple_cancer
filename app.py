...
from features import hospital_map, diet_plan, yoga_plan, chatbot
...
def app_dashboard():
    ...
    section = st.sidebar.radio("Go to", 
                ["Breast Cancer", "Lung Cancer", "Liver Cancer", "Skin Cancer", "Colorectal Cancer",
    ...
    elif section == "Colorectal Cancer":
        colorectal_cancer.predict_colorectal()
